...
const HeroSection: React.FC = () => {
  return (
    <section className="py-24 md:py-32 bg-recoai-lightGray">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Unlock AI-Powered <span className="gradient-text">E-commerce Insights</span>
          </h1>
          <p className="text-xl md:text-2xl text-recoai-gray mb-8 max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-sm text-recoai-gray">
