...
const LandingFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-recoai-darkGray text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <Link to="/" className="text-2xl font-bold gradient-text">RecoAI</Link>
            <p className="mt-4 text-gray-400 pr-4">
              Empowering e-commerce stores with AI-powered insights to understand customers and boost sales.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {currentYear} RecoAI. All rights reserved.
          </p>
